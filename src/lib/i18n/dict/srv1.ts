...
export const tr: Dict = {
  ...
  "srv.co.err.storeLocked": "Satışlar şu an geçici olarak kapalı. Çok yakında!",
...
export const en: Dict = {
  ...
  "srv.co.err.storeLocked": "Sales are temporarily closed. Coming very soon!",
...
export const de: Dict = {
  ...
  "srv.co.err.storeLocked": "Der Verkauf ist vorübergehend geschlossen. Sehr bald!",
...
export const ar: Dict = {
  ...
  "srv.co.err.storeLocked": "المبيعات مغلقة مؤقتًا. قريبًا جدًا!",
...
export const ru: Dict = {
  ...
  "srv.co.err.storeLocked": "Продажи временно закрыты. Совсем скоро!",
